      ...
      <div class="">
        <div class="flex">
            ...
            <div class="footer-section">
                ...
                <p class=" ">
                <a href="#!" class=" ">eazipay@gmail.com</a>
                </p>
                <p class=" ">
                <a href="#!" class=" ">+234 816 878 9518</a>
                </p>
                <p class="footer-input relative flex items-center">
                    <input type="email" name="email" placeholder="Your email address" />
                    <svg style="right: 16px" class="absolute" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
